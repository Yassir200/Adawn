              ...
              <div className="lg:col-span-5">
                <div className="bg-white dark:bg-slate-800 p-6 xl:p-8 rounded-[2rem] shadow-sm border border-slate-100 dark:border-slate-700/50">
                  ...
                  <div className="space-y-4">
                    {/* Carte Email */}
                    <a href="mailto:support@adawn.ma" className="group bg-slate-50 dark:bg-slate-700/50 p-4 rounded-xl border border-slate-100 dark:border-slate-600 shadow-sm hover:border-blue-300 dark:hover:border-blue-500 transition-all flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400">support@adawn.ma</p>
                      </div>
                    </a>
